...
# python clear_migrate.py & python manage.py makemigrations & python manage.py makeviewmigrations & python manage.py migrate & ECHO import init_setting \n exit | python manage.py shell_plus