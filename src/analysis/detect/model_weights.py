...
class TopSubcategoryClassficationWeight(IWeight, metaclass=Singleton):
    ...
    ATTRBUTES_TYPE_ID = 9
    def __init__(self, display=True, conf_thres=0.25, imgsz=(224, 224), device='0', cls=None, weights_path=None, name=None):
        super().__init__(display, conf_thres, imgsz, device, cls, weights_path, name)
