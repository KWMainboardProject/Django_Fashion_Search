...
class image_attributes(ddm.Model):
    image = models.ForeignKey(to="image.request_image", on_delete=ddm.CASCADE, verbose_name="Image")
    attribute = models.ForeignKey(to="label.Attributes", on_delete=ddm.CASCADE, verbose_name="Attributes")
...
class ImageAttributesTable(DBView):
    ...
    maincategory = models.ForeignKey(to="label.Maincategory", on_delete=ddm.DO_NOTHING, verbose_name="Main Category ID")
    attributes = models.ForeignKey(to="label.Attributes", on_delete=ddm.DO_NOTHING, verbose_name="Attributes ID")
