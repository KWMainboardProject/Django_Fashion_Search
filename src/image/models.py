...
class request_image(Model):
    ...
    requester = models.ForeignKey(to=settings.AUTH_USER_MODEL, related_name='+', on_delete=models.CASCADE)
    analysis_state = models.CharField(max_length=1, choices=WORK_STATE, verbose_name="Work State", default="N")